...
class WanVAE:
    def __init__(
        ...
        vae_pth = vae_path
        assert vae_pth is not None, "vae_pth must not be None"
        assert not load_mean_std, "make sure mean_std_path is not used."
...
class Wan2pt1VAEInterface(VideoTokenizerInterface):
    def __init__(
        self, vae_path: str, chunk_duration: int = 81, load_mean_std=False, max_video_length: int = 500, **kwargs
    ):
